...
public class BlueSpruceGrowthDefinition extends LSystemBasedTreeGrowthDefinition {
    ...
    public BlueSpruceGrowthDefinition() {
        ...
        TreeBlockDefinition blueSpruceBranch = new TreeBlockDefinition("AnotherWorldPlants:BlueSpruceBranch",
        ...
        SurroundAxionElementGeneration largeBranchGeneration = new SurroundAxionElementGeneration(blueSpruceBranch,
