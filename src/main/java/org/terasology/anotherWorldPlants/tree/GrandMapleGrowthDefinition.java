...
public class GrandMapleGrowthDefinition extends LSystemBasedTreeGrowthDefinition {
    ...
    public static final String GENERATED_BLOCK = "AnotherWorldPlants:GrandMapleSaplingGenerated";
    ...
    public GrandMapleGrowthDefinition() {
        ...
        TreeBlockDefinition grandMapleBranch = new TreeBlockDefinition("AnotherWorldPlants:GrandMapleBranch",
        ...
        SurroundAxionElementGeneration largeBranchGeneration = new SurroundAxionElementGeneration(grandMapleBranch,
