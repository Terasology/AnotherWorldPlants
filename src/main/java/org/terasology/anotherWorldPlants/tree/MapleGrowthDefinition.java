...
public class MapleGrowthDefinition extends LSystemBasedTreeGrowthDefinition {
    ...
    public static final String GENERATED_BLOCK = "AnotherWorldPlants:MapleSaplingGenerated";
    ...
    public MapleGrowthDefinition() {
        ...
        TreeBlockDefinition mapleBranch = new TreeBlockDefinition("AnotherWorldPlants:MapleBranch",
        ...
        SurroundAxionElementGeneration largeBranchGeneration = new SurroundAxionElementGeneration(mapleBranch,
