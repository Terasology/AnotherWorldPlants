...
public class PineGrowthDefinition extends LSystemBasedTreeGrowthDefinition {
    ...
    public static final String GENERATED_BLOCK = "AnotherWorldPlants:PineSaplingGenerated";
    ...
    public PineGrowthDefinition() {
        ...
        TreeBlockDefinition pineBranch = new TreeBlockDefinition("AnotherWorldPlants:PineBranch", PartOfTreeComponent.Part.BRANCH);
