...
public class OakGrowthDefinition extends LSystemBasedTreeGrowthDefinition {
    ...
    public OakGrowthDefinition() {
        ...
        TreeBlockDefinition oakBranch = new TreeBlockDefinition("AnotherWorldPlants:OakBranch",
        ...
        SurroundAxionElementGeneration largeBranchGeneration = new SurroundAxionElementGeneration(oakBranch,
